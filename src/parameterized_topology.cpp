...
std::string ParameterizedTopology::get_dir() {
    return dir;
}

std::string ParameterizedTopology::get_property() {
    return prop;
}

std::string ParameterizedTopology::get_operation() {
    return op;
}

std::string ParameterizedTopology::get_value() {
    return val;
}
