...
public:
	AssetGroup(std::vector<Quality> hypo_quals, std::vector<Topology> hypo_topos, std::vector<int> pperm) :
			hypothetical_qualities(move(hypo_quals)), hypothetical_topologies(move(hypo_topos)), perm(move(pperm)) {}
